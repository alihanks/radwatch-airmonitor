...
sys.path.insert(0,'..')
from image_scripts.weather_utils import *
from image_scripts.windrose import WindroseAxes
...
def draw_compass(wind_direction,wind_speed,time_win_str):
    dir_= old_div(sum(dot_product(wind_direction,wind_speed)),sum(wind_speed))
